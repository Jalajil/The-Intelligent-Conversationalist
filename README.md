...
| **Experiment3_model (First Approach)** | **Deep learning classifier** predicting Positive vs Negative. Inputs = **Daei message text** + **sentiment score**. Neutral labels excluded to improve results. |
