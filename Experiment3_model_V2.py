# In this version we are training the model without Daei's messages sentiment score.
...
wants_to_convert_path = r'D:\Roken Alhewar Datasset\filtered_results1\Wants_to_Convert'
